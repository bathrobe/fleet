  ...
  return (
    <div className="mx-auto max-w-3xl p-4">
      <div className="rounded-lg border border-green-200 bg-card p-6 shadow-sm">
        <h1 className="mb-4 text-2xl font-bold">{atom.title || 'Untitled Synthesized Atom'}</h1>
        ...
        {atom.theoryFiction && (
          <div className="mb-6">
            <h3 className="mb-2 text-sm font-semibold uppercase">Theory Fiction</h3>
            <blockquote className="border-l-4 border-green-300 pl-4 italic bg-gray-50 dark:bg-gray-800 p-3 rounded">
              {atom.theoryFiction}
            </blockquote>
          </div>
        )}
        ...
        {atom.posting && (
          <div className="mb-6">
            <h3 className="mb-2 text-sm font-semibold uppercase">Posting Status</h3>
