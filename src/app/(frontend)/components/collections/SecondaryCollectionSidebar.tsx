...
export function SecondaryCollectionSidebar({
  ...
  return (
    <div className="flex flex-col w-64 h-full border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shrink-0 overflow-hidden">
      {/* Header - Fixed at top */}
      <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex-shrink-0">
        ...
        <div className="mt-2 text-xs text-muted-foreground">{items.length} items</div>
      </div>
